...
const VideoSection: React.FC = () => {
  return <section className="from-tokenise-purple to-blue-300 py-16 md:py-24 px-6 md:px-12 flex flex-col items-center bg-[tokenise-light-purple]">
      ...
      <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 max-w-4xl w-full shadow-lg mb-12">
        <div className="aspect-video bg-tokenise-light-purple/60 rounded-lg flex items-center justify-center relative overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center">
            <iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="Tokenise Introduction" className="w-full h-full" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen>
            </iframe>
